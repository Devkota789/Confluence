      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/spaces" 
              className="inline-flex items-center px-8 py-4 bg-primary text-white rounded-lg hover:bg-primary-dark transition font-medium text-lg shadow-lg hover:shadow-xl"
            >
              Browse Spaces
        ...
        <div className="mt-20 bg-gradient-to-r from-primary to-blue-600 rounded-2xl p-8 text-white">
          ...
          <div className="space-y-3">
            <div className="flex items-start space-x-3">
              <span className="bg-white text-primary w-8 h-8 rounded-full flex items-center justify-center font-bold flex-shrink-0">1</span>
              <p className="text-lg">Browse existing spaces or create a new one (Admin only)</p>
            </div>
            <div className="flex items-start space-x-3">
              <span className="bg-white text-primary w-8 h-8 rounded-full flex items-center justify-center font-bold flex-shrink-0">2</span>
              <p className="text-lg">Create pages within spaces to document your work</p>
            </div>
            <div className="flex items-start space-x-3">
              <span className="bg-white text-primary w-8 h-8 rounded-full flex items-center justify-center font-bold flex-shrink-0">3</span>
              <p className="text-lg">Collaborate with team members in shared spaces</p>
            </div>
            <div className="flex items-start space-x-3">
              <span className="bg-white text-primary w-8 h-8 rounded-full flex items-center justify-center font-bold flex-shrink-0">4</span>
